...
- `js/miracles.js`
  ...
  - 奇跡結果の口調別セリフはすべて `miracleLines.js` に持ち、このファイルは会話エンジン経由で引くだけにする。
...
- `js/data/dialogue/miracleLines.js`
  - 奇跡結果モーダル反応。清拭、常春、宴会、狂宴、酒杯、戦神、雷霆、豊穣、マナ、ミダス、悍ましい肖像画、旅人、市場、出立、結婚と、名指しの表を持たない奇跡向けの汎用反応を扱う。豊穣の角は豊穣の奇跡と同じ反応を使う。
