...
const WISH_TONE_PATTERNS = {
  ...
  "ハーピー": {
    start: line => `${line} 何とかしておくれ。頼んだよ、神さま。`,
    complete: line => `${line} やるじゃないか、神さま。恩に着るよ。`
  },
  "おっとり": {
...
const SAVE_SOMEONE_LINES = {
  ...
  "ハーピー": t => `${t}が死にかけてる。あたしの命でいい、あいつを助けておくれ。`,
...
export const WISH_DEFINITIONS = [
  ...
  },
  {
    ...
    completionLines: {
      ...
      exchangedBody: () => "この身体には、はじめから傷などない。まるで生まれ変わったようだ。"
    }
  },
  {
    id: "grow_up",
