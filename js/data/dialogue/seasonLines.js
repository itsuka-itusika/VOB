...
export const SEASONAL_LINES = {
    "春": {
      ...
      "ハーピー": ["春か。風がぬるくなったね。", "花の匂いがうるさいくらいだ。悪くはないけどね。", "気流が柔らかい。飛ぶにはいい季節だよ。"],
    ...
    "夏": {
      ...
      "ハーピー": ["暑いな……日陰を寄越してくれ。", "水を浴びたい。冷たいものはないのかい。", "夏の夜は風が止まる。飛びにくくて敵わないよ。"],
    ...
    "冬": {
      ...
      "ハーピー": ["寒い。誰か火を焚いてくれ。", "雪は綺麗だね。羽が濡れるのは好かないけど。", "暖かいところで一杯やろうじゃないか。"],
