...
export const SEASONAL_LINES = {
    "春": {
      ...
      "ハーピー": ["春か。風がぬるくなったね。", "花の匂いがうるさいくらいだ。悪くはないけどね。", "陽が長くなった。動きやすくていい。"],
    "スフィンクス": ["春か。何度見ても、巡るものは飽きないな。", "花の匂いが濃い。悪くはないよ。", "陽が長くなった。考え事がはかどる。"],
    ...
    "夏": {
      ...
      "ハーピー": ["暑い。日陰を寄越してくれ。", "水を浴びたい。冷たいものはないのかい。", "この暑さじゃ、昼間は動く気にならないよ。"],
    "スフィンクス": ["暑いな。日陰を分けてもらえるかい。", "水を浴びたい。冷たいものはないか。", "この暑さでは、昼間に頭が回らない。"],
    ...
    "秋": {
      ...
      "ハーピー": ["実りの季節だね。腹が満ちるのはいいことだ。", "収穫祭かい。騒ぐのは嫌いじゃないよ。", "夜が長いね。眠るには向いてる。"],
    "スフィンクス": ["実りの季節だね。腹が満ちるのはいいことだ。", "収穫祭か。騒ぐのは嫌いではないよ。", "夜が長い。物を考えるには向いている。"],
    ...
    "冬": {
      ...
      "ハーピー": ["寒い。誰か火を焚いてくれ。", "雪は綺麗だね。冷えるのは好かないけど。", "暖かいところで一杯やろうじゃないか。"],
    "スフィンクス": ["寒いな。誰か火を焚いてくれ。", "雪は美しい。冷えるのは好かないがね。", "暖かい場所で一杯やろうじゃないか。"],
