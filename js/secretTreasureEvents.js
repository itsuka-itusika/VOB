...
export const MERCHANT_SECRET_TREASURE_CHANCE = 0.1;
...
const EVENT_DEFINITIONS = {
  field: {
    ...
    imagePath: "images/events/secret-treasure-field.webp"
  },
  fishing: {
    title: "網にかかった秘宝",
    logPrefix: "網に奇妙な物がかかった",
    message: "引き上げた網の中に、魚でも流木でもない奇妙な品が絡まっていました。水を払うと淡い光がこぼれ、秘宝として村に納められました。",
    imagePath: "images/events/secret-treasure-fishing.webp"
  },
  merchant: {
    title: "行商人の秘蔵品",
