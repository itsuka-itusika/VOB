async page => {
  const scenarioIds = [
    "raid-stress-mapped-village-normal",
    "raid-stress-rich-village-normal",
    "raid-stress-prosperous-village-normal"
  ];
  ...
  await page.goto("http://127.0.0.1:4173/tools/balance/index.html?variant=frontline-full-intercept-a");
