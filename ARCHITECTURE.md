...
- `js/tutorial.js`
  - チュートリアル項目の達成状態、警告欄表示、達成報酬、達成モーダルを扱う。
- `js/exchange.js`
  - 肉体と精神の交換処理を扱う。
- `js/buildings.js`
...
- `js/data/`
  ...
  - `js/data/tutorialData.js` はチュートリアル項目と報酬秘宝IDを持つ。
...
`tutorial` を持たない既存セーブデータは、読み込み時に未達成状態として初期化します。全項目達成後は `tutorial.complete` が true になり、警告欄には表示されません。
